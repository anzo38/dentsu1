<?php
/* Smarty version 3.1.36, created on 2021-03-03 13:28:45
  from '/data/inquiry2.local/src/templates/input.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_603f8f0d0a3204_90341279',
...
function content_603f8f0d0a3204_90341279 (Smarty_Internal_Template $_smarty_tpl) {
				...
				<form action="contact.php?gui=2" method="post">
				 ...
				 <table class="formTable">
					<tr>
					 ...
					 <td><input type="text" name="name" id="e_163" value="<?php echo $_smarty_tpl->tpl_vars['name']->value;?>
" size="30" maxlength="50" /></td>
					...
					<tr>
					 ...
					 <td><input type="email" name="e_mail" id="e_164" value="<?php echo $_smarty_tpl->tpl_vars['e_mail']->value;?>
" size="30" maxlength="50" /></td>
					</tr>
...
?>
					 ...
					 <td><label><input type="checkbox" name="question[]" value="<?php echo $_smarty_tpl->tpl_vars['question_v']->value;?>
...
?>
					 <th><label><input type="radio" name="category" value=<?php echo $_smarty_tpl->tpl_vars['category_v']->value;?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
					...
					<tr>
						...
						<td><input type="date" name="date" value="<?php echo $_smarty_tpl->tpl_vars['date']->value;?>
"></td>
					</tr>
...
>
					...
					<tr>
					 ...
					 <option value="course1"<?php echo $_smarty_tpl->tpl_vars['course1']->value;?>
>スタンダード</option>
				     <option value="course2"<?php echo $_smarty_tpl->tpl_vars['course2']->value;?>
>プレミアム</option>
					 <option value="course3"<?php echo $_smarty_tpl->tpl_vars['course3']->value;?>
>プラチナ</option>
					 <option value="course4"<?php echo $_smarty_tpl->tpl_vars['course4']->value;?>
>ゴールド</option>
					 </select>
					 </td>
					</tr>
	               ...
	               <tr>
				     ...
				     <td>
					 <textarea name="comment" rows="10" cols="50" id="e_193" ><?php echo $_smarty_tpl->tpl_vars['comment']->value;?>
</textarea>
					 </td>
					</tr>
...
<?php echo '<script'; ?>
 type="text/javascript" src="https://contact.dentsu.jp/img?id=116&t=9lwd&v=0e6b34bc"><?php echo '</script'; ?>
>
<!--/DO NOT REMOVE/-->
